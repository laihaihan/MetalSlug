...
import com.derek.game.Graphics;
import com.derek.metalslug.GameView;
import com.derek.metalslug.ViewManager;
...
public class Monster {// 定义代表怪物类型的常量（如果程序还需要增加更多怪物，只需在此处添加常量即可）
